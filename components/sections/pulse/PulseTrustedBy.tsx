...
export function PulseTrustedBy() {
  return (
    <section className="py-10 md:py-12 border-y border-[rgba(0,0,0,0.06)] bg-[#fafaf9]/30">
      <Container>
        <AnimatedSection>
          <p className="text-center text-[10px] text-[#171717]/40 uppercase tracking-[0.15em] mb-6">
