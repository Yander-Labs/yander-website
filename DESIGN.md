...
### Collapsing Strategy
- **Navigation**: Full horizontal nav to hamburger on mobile
- **Hero**: 64px Cal Sans display to ~36px on mobile
- **Feature grids**: Multi-column to 2-column to single stacked column
